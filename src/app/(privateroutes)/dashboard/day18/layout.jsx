...
function IconHome({ className = "" }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" aria-hidden="true">
      ...
      <path d="M9.5 21.5V14a1 1 0 0 1 1-1h3a1 1 0 0 1 1 1v7.5" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
    </svg>
  );
}
function IconBox({ className = "" }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" aria-hidden="true">
      <path d="M12 2 3.5 6.5 12 11l8.5-4.5L12 2Z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
      <path d="M3.5 6.5V17.5L12 22l8.5-4.5V6.5" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
      <path d="M12 11v11" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
function IconSpark({ className = "" }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" aria-hidden="true">
      <path d="M12 2l2.1 6.3L20 10l-5.9 1.7L12 18l-2.1-6.3L4 10l5.9-1.7L12 2Z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
      <path d="M5 20l1-3M19 20l-1-3" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
function IconChat({ className = "" }) {
  return (
    <svg viewBox="0 0 24 24" className={className} fill="none" aria-hidden="true">
      <path d="M20 14a4 4 0 0 1-4 4H9l-5 3V6a4 4 0 0 1 4-4h8a4 4 0 0 1 4 4v8Z" stroke="currentColor" strokeWidth="2" strokeLinejoin="round" />
...
export default function Day18Layout({ children }) {
  ...
  const nav = [
    { href: "/dashboard/day18", label: "Entry", Icon: IconHome },
    { href: "/dashboard/day18/products", label: "Products", Icon: IconBox },
    { href: "/dashboard/day18", label: "Ad Builder", Icon: IconSpark },
  ...
  return (
    <div className="min-h-screen bg-zinc-950 text-white">
      ...
      <div className="relative flex min-h-screen">
        {/* Sidebar (flush left, no padding outside) */}
            ...
            <div className="flex flex-1 items-center">
              <div className="flex flex-col gap-4">
                {nav.map((item) => {
                  ...
                  return (
                    <NavIconButton key={item.label} href={item.href} label={item.label} active={active}>
