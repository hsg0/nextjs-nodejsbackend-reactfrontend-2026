...
export default function Day25TheEndPage() {
  ...
  useEffect(() => {
    ...
    console.log("[Day25TheEndPage] theendValue:", theendValue);
  ...
  return (
    <div className="min-h-screen bg-black text-white p-6">
      <div className="max-w-5xl mx-auto space-y-5">
        <div className="rounded-2xl border border-white/10 bg-black/40 p-6">
          <h1 className="text-2xl font-extrabold">Day 25 — ✅ [theend]</h1>
        ...
        <Card title="1) Route Params (useParams)" subtitle="From folder segments">
          ...
          <div className="mt-3 text-xs text-white/50">
            ...
            <span className="text-white/70">
              /dashboard/day25/props/{useparamsValue}/{usesearchparamsValue}/routerused/{theendValue}
            </span>
          </div>
        </Card>
