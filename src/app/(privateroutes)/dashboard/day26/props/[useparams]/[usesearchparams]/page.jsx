// src/app/(privateroutes)/dashboard/day26/props/[useparams]/[usesearchparams]/page.jsx
"use client";
...
export default function Day26UseSearchParamsPage() {
  ...
  const linkingUrl = useMemo(() => {
    return `/dashboard/day26/props/${useparamsValue}/${usesearchparamsValue}/linking${carryQS}`;
  ...
  useEffect(() => {
    ...
    if (!isAuthenticated) {
      console.log("[Day26UseSearchParamsPage] ❌ not authenticated -> /login");
  ...
  useEffect(() => {
    console.log("[Day26UseSearchParamsPage] params:", params);
    console.log("[Day26UseSearchParamsPage] useparamsValue:", useparamsValue);
    console.log("[Day26UseSearchParamsPage] usesearchparamsValue:", usesearchparamsValue);

    console.log("[Day26UseSearchParamsPage] query:", query);
    console.log("[Day26UseSearchParamsPage] level:", level);
    console.log("[Day26UseSearchParamsPage] serverMsg:", serverMessage);

    console.log("[Day26UseSearchParamsPage] linkingUrl:", linkingUrl);
    console.log("[Day26UseSearchParamsPage] routerusedUrl:", routerusedUrl);
  ...
  return (
    <div className="min-h-screen bg-black text-white p-6">
      <div className="max-w-5xl mx-auto space-y-5">
        <div className="rounded-2xl border border-white/10 bg-black/40 p-6">
          <h1 className="text-2xl font-extrabold">Day 26 — useSearchParams()</h1>
        ...
        >
          <div className="rounded-xl border border-white/10 bg-black/40 p-4">
            ...
            <div className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-3">
              <button
                onClick={() => {
                  console.log("[Day26UseSearchParamsPage] router.push ->", linkingUrl);
              ...
              <button
                onClick={() => {
                  console.log("[Day26UseSearchParamsPage] router.push ->", routerusedUrl);
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              <Link
                href={linkingUrl}
                className="rounded-xl border border-white/10 bg-black/40 px-4 py-2 hover:bg-black/60"
                onClick={() => console.log("[Day26UseSearchParamsPage] <Link> ->", linkingUrl)}
              >
                Link to linking
              </Link>
              ...
              <Link
                href={routerusedUrl}
                className="rounded-xl border border-white/10 bg-black/40 px-4 py-2 hover:bg-black/60"
                onClick={() => console.log("[Day26UseSearchParamsPage] <Link> ->", routerusedUrl)}
              >
                Link to routerused
              </Link>
            </div>
        ...
        <div className="text-xs text-white/60 flex flex-wrap gap-4">
          ...
          <button
            onClick={() => {
              console.log("[Day26UseSearchParamsPage] router.back()");
              router.back();
            }}
