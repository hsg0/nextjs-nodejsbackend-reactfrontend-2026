// src/app/(privateroutes)/dashboard/day26/props/[useparams]/[usesearchparams]/(userouter)/linking/page.jsx
"use client";
...
export default function Day26LinkingPage() {
  ...
  useEffect(() => {
    ...
    if (!isAuthenticated) {
      console.log("[Day26LinkingPage] ❌ not authenticated -> /login");
      router.replace("/login");
    }
  }, [loading, isAuthenticated, router]);

  useEffect(() => {
    console.log("[Day26LinkingPage] params:", params);
    console.log("[Day26LinkingPage] query:", query, "level:", level);
    console.log("[Day26LinkingPage] serverMsg:", serverMsg);
  ...
  return (
    <div className="min-h-screen bg-black text-white p-6">
      <div className="max-w-5xl mx-auto space-y-5">
        <div className="rounded-2xl border border-white/10 bg-black/40 p-6">
          <h1 className="text-2xl font-extrabold">Day 26 — Linking</h1>
          ...
          <div className="rounded-xl border border-white/10 bg-black/40 p-4">
            ...
            <div className="mt-4 flex flex-wrap gap-3">
              ...
              <Link
                ...
                onClick={() => console.log("[Day26LinkingPage] <Link> -> routerused", goToRouterused)}
              >
              ...
              <Link
                ...
                className="rounded-xl border border-white/10 bg-black/40 px-4 py-2 hover:bg-black/60"
                onClick={() =>
                  console.log("[Day26LinkingPage] <Link replace> -> routerused", goToRouterused)
                }
              >
              ...
              <Link
                ...
                onClick={() =>
                  console.log(
                    "[Day26LinkingPage] <Link prefetch={false}> -> back",
              ...
              <button
                onClick={() => {
                  console.log("[Day26LinkingPage] router.push ->", goToRouterused);
              ...
              <button
                onClick={() => {
                  console.log("[Day26LinkingPage] router.back()");
                  router.back();
                }}
                className="rounded-xl border border-white/10 bg-black/40 px-4 py-2 hover:bg-black/60"
              >
